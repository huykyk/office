...
var $config={
	...
	right			: 10,
	display			: true,
	contentUrl		: "http://www.chinaitlab.com/gmail/hot/hot.html",
	time : {
		slideIn			: 10,
		hold			: 10,
		slideOut		: 10
...
function PopUp(id, config){
	...
	this.imgMin = "http://www.chinaitlab.com/gmail/hot/images/U814P346T1D1076F6DT20070725145920.gif";
	this.imgMax = "http://www.chinaitlab.com/gmail/hot/images/U814P346T1D1076F352DT20070725145920.gif";
}
...
var __o={
	create : function (){
		...
		sBtn.style.cssText='position:absolute;\
							...
							height:15px;\
							\
							background-image:url("http://www.chinaitlab.com/gmail/hot/images/U814P346T1D1076F6DT20070725145920.gif");';
		...
		btn.style.cssText='position:absolute;\
							...
							height:15px;\
							\
							background-image:url("http://www.chinaitlab.com/gmail/hot/images/U814P346T1D1076F354DT20070725152720.gif");';
...
function job(){
	...
	*/
	...
	var cookieName="chinaitlab_popup_next_display_time";
